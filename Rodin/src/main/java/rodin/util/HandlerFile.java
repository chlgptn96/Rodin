...
public class HandlerFile {
	...
	public HandlerFile(MultipartHttpServletRequest multipartRequest, String filePath, String userEmail) {
	...
	public Map<String, List<String>> getUploadFileName() {
		logger.debug("-- Get Filenames --");
		upload();
		return fileNames;
	}
	
	public byte[] getDownloadFileByte() {
		logger.debug("-- Get Download File's size --");
		download();
		return fileByte;
	}
	...
	public String getFileFullPath() {
		logger.debug("-- Get Full Filepath --");
		return fileFullPath;
	}
