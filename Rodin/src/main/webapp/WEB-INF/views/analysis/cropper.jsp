...
<html>
	<head>
		...
		<link rel="stylesheet" href="<c:url value="/assets/css/css_cropper/main.css"/>" />
		<!--
  ...
  <footer class="footer">
    <div class="container">
      ...
      <nav class="nav flex-wrap justify-content-center mb-3">
		...
		<script src="<c:url value="/assets/js/js_cropper/main.js" />" ></script>
		<!-- 
		<script src="<c:url value="/assets/js_cropper/jquery-cropper.js" />" ></script>
 		-->
	</body>
